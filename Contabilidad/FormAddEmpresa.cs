...
namespace Contabilidad
{
    public partial class FormAddEmpresa : Form
    {
        ...
        private EDM.EDM edm;
        public string PeriodoAnteriorFullPath = "";

        public FormAddEmpresa(EDM.EDM edm_)
        {
            edm = edm_;
            InitializeComponent();
        }
        ...
        private void label4_Click(object sender, EventArgs e)
        {
            ...
            EDM.Empresa empresaSeleccionada = form.EmpresaActual;
            form.Dispose();
            form = null;

            txtEmpresa.Text = empresaSeleccionada.Name;
            DateTime fechaInicial = empresaSeleccionada.FechaFinal;
            txtInicio.Text = String.Format("{0:dd/MM/yyyy}", fechaInicial.AddDays(1));
            txtFinal.Text = "";

            PeriodoAnteriorFullPath = empresaSeleccionada.FullPath;
        }
