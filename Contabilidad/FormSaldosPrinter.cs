...
namespace Contabilidad
{
    public partial class FormSaldos : Contabilidad.BasicForm
    {
        ...
        private bool SetupThePrinting(DataGridView dtGrid, string name)
        {
            ...
            //11-11-2014 No se porque estaba esto aca. con esto no aparecia nada.
            ...
            if (MessageBox.Show("¿Desea centrar el reporte en la pagina?",
                ...
                FontStyle.Bold, GraphicsUnit.Point), Color.Black, true, dtGrdTotales);
            else
                MyDataGridViewPrinter = new DataGridViewPrinter(dtGrid,
        ...
        {
            if (SetupThePrinting(this.dtgrdSaldos, title)) //lbEmpresa.Text))
