...
namespace Contabilidad
{
    public partial class FormSaldos : Contabilidad.BasicForm
    {
        ...
        private void prepareDtGrd(List<EDM.Entity.Asiento> asientos)
        {
            ...
            saldoDColumn.HeaderText = "Saldo Deudores";
            ...
            saldoHColumn.HeaderText = "Saldo Acreedores";
            saldoHColumn.DefaultCellStyle.Format = "N2";
            

            dtgrdSaldos.Columns.Add(idColumn);
            dtgrdSaldos.Columns.Add(descriptionColumn);
            dtgrdSaldos.Columns.Add(acumDColumn);
            dtgrdSaldos.Columns.Add(acumHColumn);
            dtgrdSaldos.Columns.Add(saldoDColumn);
            dtgrdSaldos.Columns.Add(saldoHColumn);
        ...
        private void agregarTotales()
        {
            ...
            saldoDColumn.HeaderText = "Total Saldo Deudores";

            DataGridViewTextBoxColumn saldoHColumn = new DataGridViewTextBoxColumn();
            saldoHColumn.Width = dtgrdSaldos.Columns[5].Width;
            saldoHColumn.HeaderText = "Total Saldo Acreedores";
